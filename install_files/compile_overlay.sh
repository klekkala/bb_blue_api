...
dtc -O dtb -o /lib/firmware/$MPU_OVERLAY.dtbo -b 0 -@ 2016-05-01/$MPU6500_OVERLAY.dts

echo "Installing $MPU6050_OVERLAY Device Tree Overlay"
dtc -O dtb -o /lib/firmware/$BMP_OVERLAY.dtbo -b 0 -@ 2016-05-01/$MPU6050_OVERLAY.dts
